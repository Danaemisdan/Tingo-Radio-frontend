...
export const SplashHero = ({ onTuneIn }: { onTuneIn: () => void }) => {
  ...
  // Initialize audio analyzer from a dummy context just to feed the visualizer some data if we wanted, 
  // but since we don't have audio playing on the splash screen, we will rely on the "Demo animation" branch 
  // already present in the canvas animation loop!
    ...
    <div className="relative w-full h-full min-h-screen bg-[#050505] overflow-hidden flex flex-col items-center justify-center font-sans">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-3xl space-y-8">
        ...
        <h1 className="text-3xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-white to-white/40 tracking-tighter uppercase drop-shadow-lg">
          Booting Up The<br/>Radio For You
        </h1>
        
        <p className="text-white/60 text-base md:text-lg font-medium tracking-wide max-w-lg mt-4 mb-6">
          Experience 24/7 autonomous AI radio, generated live.
        </p>
